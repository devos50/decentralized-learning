...
def get_args(dataset: str, default_lr: float, default_momentum: float = 0):
    ...
    parser.add_argument('--instant-network', action=argparse.BooleanOptionalAction)
    ...
    parser.add_argument('--cohort-participation', type=int, default=10)
    ...
    parser.add_argument('--aggregation-timeout', type=float, default=0)
