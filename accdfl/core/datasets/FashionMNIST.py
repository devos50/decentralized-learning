...
class FashionMNIST(Dataset):
    ...
    def load_trainset(self):
        ...
        if FashionMNIST.FashionMNIST_trainset:
            trainset = FashionMNIST.FashionMNIST_trainset
        else:
            trainset = torchvision.datasets.FashionMNIST(
                root=self.train_dir, train=True, download=True, transform=self.train_transformer
            )
            FashionMNIST.FashionMNIST_trainset = trainset
        ...
        if self.partitioner == "iid":
            ...
            raise RuntimeError("Unknown partitioner %s for FashionMNIST dataset", self.partitioner)
    ...
    def test(self, model, device_name: str = "cpu"):
        ...
        self.logger.debug("Device for FashionMNIST accuracy check: %s", device)
