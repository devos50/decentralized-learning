...
class MNIST(Dataset):
    ...
    def load_trainset(self):
        ...
        if self.partitioner == "iid":
            ...
            raise RuntimeError("Unknown partitioner %s for MNIST dataset", self.partitioner)
    ...
    def test(self, model, device_name: str = "cpu"):
        ...
        self.logger.debug("Device for MNIST accuracy check: %s", device)
